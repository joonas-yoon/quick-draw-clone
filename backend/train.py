...
#     optimizer, T_0=6, T_mult=2, eta_min=1e-5)
# scheduler = optim.lr_scheduler.CyclicLR(
#     optimizer, base_lr=0.00001,
#     step_size_up=5, max_lr=LEARNING_RATE,
#     cycle_momentum=False,
#     gamma=0.75, mode='triangular2')
...
# %%
early_stopper = EarlyStopper(patience=20, threshold=1e-2)
